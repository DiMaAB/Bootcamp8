...
//   console.log(b.albums.entities['1386'].series['id']);
...
// console.log(navigator); // информация твоего железа
// console.log(navigator.userAgent); // информация твоего железа именно про тебя
// console.log(navigator.vendor);
// console.log(window.screen);
// console.log(location); // твое место нахождение
// console.log();

// // DOM =набор обьектов которые дают возможность сформировать сайт(набор HTML документов)
// // BOM - встроене обьекты браузера которые дают возможность узнать информацию о поьзователя
