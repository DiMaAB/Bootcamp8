...
render() {
  ...
  return (
    ...
    {showModal &&<Modal toggleModal={this.toggleModal}/>}
      ...
      <p><input type="text" id="check1"><label for="check1">Lorem</label>
   <input type="text" id="check2"><label for="check2">Ipsum</label>
   <input type="text" id="check3"><label for="check3">Dolor</label>
   <input type="text" id="check4"><label for="check4">Sit amet</label></p>
